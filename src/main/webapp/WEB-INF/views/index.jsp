    ...
    <li>
      ...
      <div class="left_bottom">
        <h1 class="banner_title">나에게 딱 맞는 거래, 시소마켓</h1>
          <div class="slogan">
          <p><span class="sig-color">S</span>elect
                    <span class="sig-color">Y</span>our
         <span class="sig-color">S</span>uitable
         <span class="sig-color">O</span>bject</p>
          </div>
        <p>누구나, 무엇이든 쉽고 편하고<br>
            안전하게 거래하는 세상을 꿈꾸고 있습니다.
          </p>   
      ...
      <li>
        ...
        <div class="event_txt">
              <p style="color: #fff;">회원가입시 추천인 아이디 입력시 추천인과
                  신규 회원님 상품 구매시 사용 가능한 3,000원 적립금 지급!</p>
              </div>  
